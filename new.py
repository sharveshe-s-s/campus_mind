...
os.environ["OPENAI_API_KEY"] = "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"

# GOOGLE DRIVE CONFIG
GOOGLE_CREDENTIALS_FILE = 'google_credentials.json' 
DRIVE_FOLDER_ID = '1IRAXoxny14JvI6UbJ1zPyUduwlzm5Egm' 

# --- 2. CUSTOM CSS (The "Winning" UI) ---
st.markdown("""
<style>
    /* Gradient Background */
    .stApp {
...
def upload_to_drive(file_path, file_name):
    """Uploads the file to Google Drive for backup"""
    try:
...
# --- PAGE 1: STUDENT CHAT (Now with Stunnning Animations!) ---
if selected == "Student Chat":
    col1, col2 = st.columns([1, 2])
    
    # Left Column: The Mascot
    with col1:
        if lottie_hello:
    ...
    st.markdown("---") # Divider line for cleaner look
        ...
        if pdf_docs:
            with st.status("Processing Data...", expanded=True) as status:
                ...
                for pdf in pdf_docs:
                    ...
                    # 2. GOOGLE DRIVE BACKUP (Safe Mode)
